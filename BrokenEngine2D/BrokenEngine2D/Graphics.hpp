...
public:
	...
	void DrawLine(int x1, int y1, int x2, int y2, wchar_t c = 0x2588, short color = 0x000F);
	void DrawString(int x, int y, std::string str, short color = 0x000F);
	void Fill(int x, int y, int width, int height, wchar_t c = 0x2588, short color = 0x000F);
